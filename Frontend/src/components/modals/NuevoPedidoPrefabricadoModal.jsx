...
export default function NuevoPedidoPrefabricadoModal({ open, onClose, tipos = [], seccion, seccionLabel, onCreate, historial = [] }) {
  ...
  return (
    ...
    >
      <div style={{ width: 'min(560px, 100%)', maxHeight: '90vh', display: 'flex', flexDirection: 'column', background: 'var(--surface)', borderRadius: 14, border: '1px solid #e5e7eb', boxShadow: '0 18px 55px rgba(0,0,0,0.25)', overflow: 'hidden' }}>
